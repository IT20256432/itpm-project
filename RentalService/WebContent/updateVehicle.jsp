    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    <h2 class="title">Update vehicle details</h2>
                    
                    <form method="post" action="Update" onsubmit="return validateInsertVehicleForm()" name="vehicleInsert">
                    
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Vehicle Id" name="RegNo" value="<%=RegNo%>"readonly>
                        </div>
                          <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Vehicle brand" name="Brand" value="<%= Brand %>" required>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-2" type="text" placeholder="Vehicle name" name="Name" value="<%= Name%>" required>  
                                </div>
                            </div>
                            <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="No of seats" name="Seats" value="<%=Seats %>" required>
                        	</div>
        
                        </div>
                        <div class="input-group">
                                    <input class="input--style-2" type="text" placeholder="Price per day" name="Price" value="<%=Price %>" required> 
                                </div>
                        <div class="input-group">
                            	 <input class="input--style-2" type="text" placeholder="Driver name" name="Driver" value="<%=Driver%>" required> 
                        </div>
                       
                   
                                <div class="input-group">
                                    <input class="input--style-2" type="text" placeholder="Driver contact No" name="PhoneNo" value="<%= PhoneNo%>"required>
                                </div>
                         ...
                         <div class="input-group">
                            	 <input class="input--style-2" type="text" placeholder="Vehicle Image" name="Image" value="<%=Image %>" required> 
                        </div>
                        
                        
                        <div class="p-t-30">
                        	<input type="submit" name="submit" value="Update My Data" class="btn btn--radius btn--green" >
