...
//	}
    ...
    public static List<employee> validate(String id) {
		...
		try {
			...
			if(rs.next()) {
				...
				employee e = new employee(id2,name,phone,email,position,salary,gender);
				emp.add(e);
			}
	...
	public static boolean updateemployee(String id,String name,String phone,String email,String position,String salary,String gender ) {
       ...
       boolean isSuccess = false;
		...
		try{
		   ...
		   String sql = "update employee set name ='"+name+"',phoneno = '"+phone+"',email = '"+email+"',position = '"+position+"',salary = '"+salary+"',gender =  '"+gender+"'" +"where id='"+id+ "'";
		   int rs = stmt.executeUpdate(sql);
	...
	public static boolean deleteemployee(String id, boolean isSuccess) {
