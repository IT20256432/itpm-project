...
public class VehicleDbUtil {
	...
	public static boolean insertVehicle(String brand, String name, String noOfSeats, String pricePerDay, String driverName, String driverPhnNo, String vehicleAvailability, String image)
	 {
			...
			try {
				...
				String sql = "insert into kvehicle_renting_system.vehicle values (0,'"+brand+"','"+name+"','"+noOfSeats+"','"+pricePerDay+"','"+driverName+"','"+driverPhnNo+"','"+vehicleAvailability+"','"+image+"')";
	...
	public static List<vehicle> getVehicleDetails(String Brand, String Name) {
		...
		try {
			con = DBconnect.getConnection();
			st = con.createStatement();
			String sql = "select * from kvehicle where brand= '"+Brand+"' and name='"+Name+"' ";
	...
	public static boolean validateSearchVehicle (String vBrand,String vName) {
		...
		try {
			...
			String sql = "SELECT EXISTS (SELECT * FROM kvehicle WHERE brand = '"+vBrand+"' and name = '"+vName+"' )";
	...
	public static boolean updateVehicle(String RegNo,String Brand,String Name,String Seats,String Price,String Driver,String PhoneNo,String Availability,String Image){
		...
		try {
			...
			String sql = "update kvehicle set brand = '"+Brand+"',name='"+Name+"',noOfSeats='"+Seats+"',pricePerDay='"+Price+"',driverName='"+Driver+"',driverPhnNo='"+PhoneNo+"',vehicleAvailability='"+Availability+"',image='"+Image+"'"
	...
	public static List<vehicle> getVehiDetails(String RegNo){
		...
		try {
			...
			String sql = "select * from kvehicle where vehicleRegNo = '"+convertedVehiId+"'";
			rs = st.executeQuery(sql);
		...
		public static boolean deleteVehicle(String RegNo) {
			...
			try {
				...
				String sql = "delete from kvehicle where vehicleRegNo='"+convtVehiId+"'";
				int rs = st.executeUpdate(sql);
